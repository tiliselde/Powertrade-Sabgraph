...
export class NewMinter extends ethereum.Event {
  get params(): NewMinter__Params {
    return new NewMinter__Params(this);
  }
}

export class NewMinter__Params {
  _event: NewMinter;

  constructor(event: NewMinter) {
    this._event = event;
  }
...
export class FuelToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class FuelToken extends ethereum.SmartContract {
  static bind(address: Address): FuelToken {
    return new FuelToken("FuelToken", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): FuelToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new FuelToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<FuelToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new FuelToken__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
